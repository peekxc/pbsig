...
<div style="padding: 0.40em; border: 1px solid black;">
__Corollary (Bauer)__: Any algorithm that preserves the ranks of the submatrices $\partial^{i,j}$ for all $i,j \in \{ 1, \dots, n \}$ is a valid barcode algorithm.
</div>

...
As the boundary operators from~\eqref{eq:rank_equiv_param} can be made to vary continuously in a parameterized setting, the only discontinuous component of the expressions from proposition~\ref{prop:mu_betti_1} is the rank function. Towards ameliorating this, we consider the spectral characterization of the rank function:

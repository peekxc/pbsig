...
If the supplied matrix-vector product operation is fast, the main bottleneck in time complexity of estimating the spectrum of $A$ is the number of iterations needed for convergence. 

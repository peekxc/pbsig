...
The Lanczos iteration and its variants are part of a family of so-called ``black box'' methods---from the user side, obtaining an eigen-decomposition of a symmetric real matrix $A$ requires only a `black box' $v \mapsto Av$ operator. 

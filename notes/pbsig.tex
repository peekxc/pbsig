...
For example, the classical least-squares workaround to solving the [possibly ill-posed] linear system $A x = b$ is often substituted with the \emph{Tikhonov regularization} (TR) for some $\epsilon > 0$:
...
\begin{figure}[ht]
	\centering
	\includegraphics[width=0.78\textwidth]{presentation/codensity_dgm_ex}

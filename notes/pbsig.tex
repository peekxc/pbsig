...
\begin{remark}
	Compared to~\eqref{eq:l_up}, is it worth remarking that one important quality lost is that $\mathcal{L}_p^{\text{up}}$ is diagonal dominance. %may no longer be diagonally dominant (though it is PSD). 
\end{remark}

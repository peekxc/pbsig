...
\begin{enumerate}
	...
	\item $p$-simplices $\tau \in K^p$ that are \emph{isolated}, i.e. do not have a proper coface $\sigma \in K^{p+1}$, then $\lVert L_p^{\text{up}}(K \setminus \tau)\rVert_{\Phi} =\lVert L_p^{\text{up}}(K)\rVert_{\Phi}$. %Similarly, 
\end{enumerate}

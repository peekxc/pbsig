...
\begin{align*}
	...
	&= (\widetilde{W}_p^i)^{+} \circ \partial_p \circ (W_{p+1}^j)^2 \circ \partial_p^T \circ (\widetilde{W}_p^i)^{+} \\
	&\propto (\widetilde{W}_p^i)^{+/2} \circ \partial_p \circ W_{p+1}^j \circ \partial_p^T \circ (\widetilde{W}_p^i)^{+/2}  \numberthis
\end{align*}
...
\subsubsection{Combinatorial Laplacians}\label{sec:comb_lap}

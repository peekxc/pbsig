...
%This is due to the fact that the nuclear norm is the tightest convex envelope of the $\mathrm{rank}$ function over the set of matrices whose spectral norm is less than $m > 0$:

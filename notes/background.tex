...
The \emph{$p$-boundary} $\partial_p[\sigma]$ of an oriented $p$-simplex $[\sigma] \in K$ is defined as the alternating sum of its oriented co-dimension 1 faces, which collectively define the $p$-th \emph{boundary matrix} $\partial_p$ of $K$:

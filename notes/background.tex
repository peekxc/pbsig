...
The collection of chains under addition yields an $\mathbb{F}$-vector space $C_p(K)$, whose elements $c \in \partial_p[c']$ are called \emph{boundaries} unless $\partial_p[c] = 0$, in which case they are called \emph{cycles}.

...
\begin{itemize}[itemsep=0.25em, parsep=0.25em]
	...
	\item (Combinations of filters) For $f, g: K \to \mathbb{R}$ filters over $K$, a natural parameterization of $K$ is the family $(K, h_\alpha)$ where $h_\alpha = (1 - \alpha) f + \alpha g$ such that $\alpha \in [0, 1]$ generates \emph{convex combinations} of $f$ and $g$.

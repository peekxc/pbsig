...
legend_text = ["(0, random)", "(1/3, random)", "(2/3, random)", "(1, random)", "(0, simple)", "(1.0, greedy)"]
...
p.line(x, naive_y, color="red", line_width=2.5, line_dash="dashed", legend_label="(0, simple)")

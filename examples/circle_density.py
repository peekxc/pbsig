...
# %% [markdown]
# Generate a noisy circle. For any choice of fixed radius $\epsilon \in \mathbb{R}_+$, we can construct a rips filtration $\mathcal{R}(X; \epsilon)$. 
# For example:
...
show(figure_dgm(ph(K, engine="dionysus")[1]))

...
max_scale = 3.0
F = lambda alpha: (alpha*circle, rips_filtration(alpha*circle, eps_radius, p=2))
...
wut = [mu_query(S, R=R, f=flag_weight(circle*alpha))() for alpha in alpha_thresholds]

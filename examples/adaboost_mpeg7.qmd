...
from pbsig.utility import train_test_split
train_ind, test_ind = train_test_split(X_aug, split=(0.70, 0.30), y=y_aug)
...
weak_learner = ShellsClassifier(bins=15)
weak_learner.fit(X_train, y_train)
weak_learner.score(X_train, y_train)
weak_learner.score(X_test, y_test)

from sklearn.ensemble import AdaBoostClassifier
A_skl = AdaBoostClassifier(ShellsClassifier(bins=15), n_estimators=1500, learning_rate=0.01, algorithm="SAMME")
